<template>
    ...
    <div class="home">
        <Spin-port-home-desktop v-show="isShowHome" ></Spin-port-home-desktop>
        <Spin-port-resume-desktop v-show="isShowResume" ></Spin-port-resume-desktop>
    </div>
